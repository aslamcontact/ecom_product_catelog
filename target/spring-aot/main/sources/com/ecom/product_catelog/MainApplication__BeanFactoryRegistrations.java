...
import com.ecom.product_catelog.api.ControllerProduct__BeanDefinitions;
import com.ecom.product_catelog.businesslayer.ProductDataService__BeanDefinitions;
import com.ecom.product_catelog.configuration.BeanConfiguration__BeanDefinitions;
import com.ecom.product_catelog.daolayer.catelog.ProductRepository__BeanDefinitions;
import com.ecom.product_catelog.exceptions.ProductExceptionHandler__BeanDefinitions;
 ...
 */
public class MainApplication__BeanFactoryRegistrations {
  /**
  ...
  public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
    ...
    beanFactory.registerBeanDefinition("mainApplication", MainApplication__BeanDefinitions.getMainApplicationBeanDefinition());
    beanFactory.registerBeanDefinition("controllerProduct", ControllerProduct__BeanDefinitions.getControllerProductBeanDefinition());
    beanFactory.registerBeanDefinition("productDataService", ProductDataService__BeanDefinitions.getProductDataServiceBeanDefinition());
    beanFactory.registerBeanDefinition("beanConfiguration", BeanConfiguration__BeanDefinitions.getBeanConfigurationBeanDefinition());
    beanFactory.registerBeanDefinition("productExceptionHandler", ProductExceptionHandler__BeanDefinitions.getProductExceptionHandlerBeanDefinition());
    beanFactory.registerBeanDefinition("mongoTemplate", BeanConfiguration__BeanDefinitions.getMongoTemplateBeanDefinition());
    beanFactory.registerBeanDefinition("mongoClient", BeanConfiguration__BeanDefinitions.getMongoClientBeanDefinition());
    beanFactory.registerBeanDefinition("price", BeanConfiguration__BeanDefinitions.getPriceBeanDefinition());
    beanFactory.registerBeanDefinition("nos-quantity", BeanConfiguration__BeanDefinitions.getNosquantityBeanDefinition());
    beanFactory.registerBeanDefinition("single-variation", BeanConfiguration__BeanDefinitions.getSinglevariationBeanDefinition());
    beanFactory.registerBeanDefinition("double-variation", BeanConfiguration__BeanDefinitions.getDoublevariationBeanDefinition());
    beanFactory.registerBeanDefinition("product-none", BeanConfiguration__BeanDefinitions.getProductnoneBeanDefinition());
    beanFactory.registerBeanDefinition("product-single", BeanConfiguration__BeanDefinitions.getProductsingleBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("mongoConnectionDetails", MongoDataAutoConfiguration__BeanDefinitions.getMongoConnectionDetailsBeanDefinition());
    ...
    beanFactory.registerBeanDefinition("mongodb.ProductRepository.fragments#0", RepositoryComposition__BeanDefinitions.RepositoryFragments.getFragmentsBeanDefinition());
